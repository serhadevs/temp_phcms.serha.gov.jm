...
@section('title', 'Barber/Cosmet Test Results')
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row justify-content-between">
                        <div class="col">
                            <h2 class="text-muted">
                                All Barber/Cosmet Test Results
                            </h2>
                        </div>
                            ...
                            <div class="row">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="/test-results/barber-cosmet/filter/0">Today</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="/test-results/barber-cosmet/filter/1">Yesterday</a>
                                        </li>
                                        <li><a class="dropdown-item" href="/test-results/barber-cosmet/filter/7">Last
                                                Week</a></li>
                                        <li><a class="dropdown-item" href="/test-results/barber-cosmet/filter/30">Last
                                                Month</a>
                                        </li>
                                        <li><a class="dropdown-item" href="/test-results/barber-cosmet/filter/90">Last
                                                3
                                                month</a>
                                        </li>
                ...
                <div class="card-body">
                    <form action="{{ route('test-results.barber-cosmet.processed.custom') }}" method="POST">
                        @csrf
                        @method('POST')
                    ...
                    @include('partials.tables.barber_cosmet_test_results')
                </div>
            </div>
        </div>
        <script>
