...
@section('title', 'Outstanding Test Results')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row justify-content-between">
                        <div class="col">
                            <h2 class="text-muted">
                                Outstanding Barber/Cosmet etc. Test Results
                            </h2>
                        </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                                href="/test-results/barber-cosmet/outstanding/filter/0">Today</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="/test-results/barber-cosmet/outstanding/filter/1">Yesterday</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="/test-results/barber-cosmet/outstanding/filter/7">Last
                                                Week</a></li>
                                        <li><a class="dropdown-item"
                                                href="/test-results/barber-cosmet/outstanding/filter/30">Last
                                                Month</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="/test-results/barber-cosmet/outstanding/filter/90">Last
                                                3
                                                month</a>
                                        </li>
                ...
                <div class="card-body">
                    <form action="{{ route('test-results.barber-cosmet.custom.outstanding') }}" method="POST">
                        @csrf
                        @method('POST')
