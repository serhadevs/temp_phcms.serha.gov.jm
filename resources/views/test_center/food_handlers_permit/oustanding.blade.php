                        ...
                        <div class="col-auto no-wrap">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="/test-results/permit/outstanding/filter/0">Today</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="/test-results/permit/outstanding/filter/1">Yesterday</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/test-results/permit/outstanding/filter/7">Last
                                            Week</a></li>
                                    <li><a class="dropdown-item" href="/test-results/permit/outstanding/filter/30">Last
                                            Month</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/test-results/permit/outstanding/filter/90">Last 3
                                            month</a>
                                    </li>
