        ...
        <div class="container-fluid mb-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{ route('tourist-establishments.renew', ['id' => $application->id]) }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="is_eating_establishment" value="1"
                                    {{ old('is_eating_establishment') ? (old('is_eating_establishment') == '1' ? 'checked' : '') : ($application->is_eating_establishment == '1' ? 'checked' : '') }}>
                                <label for="" class="form-check-label">Yes</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="is_eating_establishment" value="0"
                                    {{ old('is_eating_establishment') ? (old('is_eating_establishment') == '0' ? 'checked' : '') : ($application->is_eating_establishment == '0' ? 'checked' : '') }}>
                        ...
                        <div class="mt-3">
                            <label for="" class="form-label">Describe Eating Establishment and Seating
                                Capacity</label>
                            <textarea class="form-control" name="eating_establishment_description" oninput="this.value=this.value.toUpperCase()">{{ old('eating_establishment_description') ? old('eating_establishment_description') : $application->eating_establishment_description }}</textarea>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="establishment_state" value="new"
                                    {{ old('establishment_state') ? (old('establishment_state') == 'new' ? 'checked' : '') : ($application->establishment_state == 'new' ? 'checked' : '') }}>
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="establishment_state"
                                    ...
                                    {{ old('establishment_state') ? (old('establishment_state') == 'now being operated' ? 'checked' : '') : ($application->establishment_state == 'now being operated' ? 'checked' : '') }}>
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="authorized_officer_statement" class="form-control" oninput="this.value=this.value.toUpperCase()">{{ old('authorized_officer_statement') ? old('authorized_officer_statement') : $application->authorized_officer_statement }}</textarea>
                                ...
                                @foreach ($application->managers as $manager)
                                    <div class="border border-2 p-3 rounded border-primary mt-2"
                                        ...
                                        <button class="btn-sm btn btn-danger mt-2" type="button"
                                            onclick="removeManagement({{ json_encode($a) }})">
                                ...
                                @foreach ($application->services as $service)
                                    <div class="border border-2 p-3 rounded border-primary mt-2"
                                        ...
                                        <input type="text" class="form-control" name="services[]"
                                            value="{{ $service->name }}" oninput="this.value=this.value.toUpperCase()">
                                        @error('services.0')
