...
<body class="bg-light">
        ...
        <!-- FOOTER -->
            <div class="mt-5 pt-4" style="border-top: 3px solid #003366; background: linear-gradient(to right, #f8f9fa, #ffffff); padding: 30px 20px; border-radius: 8px; margin-left: -15px; margin-right: -15px; margin-bottom: -15px;">
                ...
                <div class="container" style="max-width: 900px;">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div style="text-align: center;">
                                <h6 style="color: #003366; font-weight: 700; margin-bottom: 5px; letter-spacing: 0.5px;">
                                   SOUTH EAST REGIONAL HEALTH AUTHORITY
                                </h6>
                                <p style="color: #b30000; font-size: 12px; margin: 0; font-weight: 600;">
                                    Public Health Certificate Management System - ID Verification By IDPRO
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4" style="padding: 20px 0; border-top: 1px solid #e0e0e0; border-bottom: 1px solid #e0e0e0;">
                        
                        <div class="col-12 col-md-4 text-center mb-3 mb-md-0">
                            <div style="padding: 10px;">
                                <small style="color: #666; display: block; margin-bottom: 5px; font-weight: 600;">CONTACT</small>
                                <a href="mailto:permits@moh.gov.jm" style="color: #b30000; text-decoration: none; font-weight: 600; font-size: 13px;">
                                    permits@serha.gov.jm
                                </a>
                            </div>
                        </div>

                        <div class="col-12 col-md-4 text-center mb-3 mb-md-0" style="border-left: 1px solid #e0e0e0; border-right: 1px solid #e0e0e0;">
                            <div style="padding: 10px;">
                        ...
                        <div class="col-12 col-md-4 text-center">
                            <div style="padding: 10px;">
                                <small style="color: #666; display: block; margin-bottom: 5px; font-weight: 600;">REFERENCE ID</small>
                                <span style="color: #333; font-weight: 600; font-size: 13px; font-family: 'Courier New', monospace;">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div style="padding: 15px; background: rgba(31, 78, 120, 0.05); border-left: 4px solid #003366; border-radius: 4px;">
                                <p style="font-size: 11px; color: #555; margin: 0; line-height: 1.6;">
                                    <strong style="color: #003366;">OFFICIAL DOCUMENT:</strong> 
                                    This E-Card is issued under the Food Safety Act (1998) and Public Health (Food Handling) Regulations. 
