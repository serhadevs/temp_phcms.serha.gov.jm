            ...
            <div class="card">
                ...
                <div class="card mt-3 mx-2">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('barber-cosmet.update.applicant', ['id' => $application->id]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mt-3">
                            ...
                            <div class="mt-3" id="edit_reason_div_1" style="display:none">
                                <label for="" class="form-label">
                                ...
                                <textarea class="form-control" name="edit_reason_one">{{ old('edit_reason_one') }}</textarea>
                                @error('edit_reason_one')
                                    <p class="text-danger applicant-error">Reason for edit is a required field.</p>
                                @enderror
                            </div>
                ...
                <div class="card mt-4 mx-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control"
                                    value="{{ empty($application->payment) ? 'NOT PAID' : 'PAID' }}" disabled>
                            </div>
                            <div class="col">
                        ...
                        <form action="{{ route('barber-cosmet.update.employment', ['id' => $application->id]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mt-3" id="edit_reason_div_2" style="display:none">
                                <label for="" class="form-label">
                                    <span class="text-danger fw-bold">
                                        *
                                    </span>
                                ...
                                <textarea class="form-control" name="edit_reason_two">{{ old('edit_reason_two') }}</textarea>
                                @error('edit_reason_two')
                                    <p class="text-danger emp_error">The reason for edit is required.</p>
                                @enderror
                            </div>
                ...
                <div class="row mt-4 mb-4 mx-1">
                    <div class="col col-md-6">
                        <div class="card" style="height:100%">
                            ...
                            <div class="card-body">
                                <form
                                    action="{{ route('barber-cosmet.update.appointments', ['id' => $application?->appointment?->first()?->id]) }}"
                                    method="POST">
                                    @method('PUT')
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $application->id }}">
                                    ...
                                    <div class="mt-3" id="edit_reason_div_3" style="display:none">
                                        <label for="" class="form-label">
                                            <span class="text-danger fw-bold">
                                                *
                                            </span>
                                        ...
                                        <textarea class="form-control" name="edit_reason_three">{{ old('edit_reason_three') }}</textarea>
                                        @error('edit_reason_three')
                                            <p class="text-danger appointment-error">The reason for edit is a required field.</p>
                                        @enderror
                                    </div>
                                    <div id="update_3" style="display:none">
                                        ...
                                        <button class="btn btn-danger mt-3" onclick="disableAppointmentInfo()"
                                            type="button">
                                            <i class="bi bi-box-arrow-left"></i>
                                            Cancel
                                        </button>
        ...
        <script>
            ...
            function enableEditing(section_id) {
                if (section_id == "1") {
                    ...
                    document.getElementById('edit_reason_div_1').style.display = "";
                    ...
                    disableAppointmentInfo();
                    document.getElementById('edit_reason_div_2').style.display = "";
                    ...
                    disableApplicantInfo();
                    disableEmployInfo();
                    document.getElementById('edit_reason_div_3').style.display = "";
            ...
            function disableApplicantInfo() {
                document.getElementById('edit_reason_div_1').style.display = "none";
                applicant_inputs = document.querySelectorAll('.applicant_inputs');
                applicant_inputs.forEach((element) => {
            ...
            function disableEmployInfo() {
                document.getElementById('edit_reason_div_2').style.display = "none";
                employ_info = document.querySelectorAll('.employ_inputs');
                employ_info.forEach((element) => {
                    element.setAttribute('disabled', true);
                })
            ...
            function disableAppointmentInfo() {
                document.getElementById('edit_reason_div_3').style.display = "none";
