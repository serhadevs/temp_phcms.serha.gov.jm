                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                                href="/downloads/food-establishments/filter/0">Today</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="/downloads/food-establishments/filter/1">Yesterday</a>
                                        </li>
                                        <li><a class="dropdown-item" href="/downloads/food-establishments/filter/7">Last
                                                Week</a></li>
                                        <li><a class="dropdown-item" href="/downloads/food-establishments/filter/30">Last
                                                Month</a>
                                        </li>
                                        <li><a class="dropdown-item" href="/downloads/food-establishments/filter/90">Last 3
                                                month</a>
                                        </li>
