                            ...
                            <div class="row">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="/downloads/foodhandlers/filter/1">Yesterday</a>
                                        </li>
                                        <li><a class="dropdown-item" href="/downloads/foodhandlers/filter/7">Last
                                                Week</a></li>
                                        <li><a class="dropdown-item" href="/downloads/foodhandlers/filter/30">Last
                                                Month</a>
                                        </li>
                                        <li><a class="dropdown-item" href="/downloads/foodhandlers/filter/90">Last 3
                                                month</a>
                                        </li>
