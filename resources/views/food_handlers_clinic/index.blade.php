...
@section('title', 'All Food Handlers Clinics')
                ...
                <div class="card-header">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-auto no-wrap">
                            <div class="row">
                                <div class="col">
                                    <a href="/food-handlers-clinics/create" class="btn btn-success">
                                        New Application
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="/food-handlers-clinics/filter/0">Today</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                                    href="/food-handlers-clinics/filter/1">Yesterday</a></li>
                                            <li><a class="dropdown-item" href="/food-handlers-clinics/filter/7">Last
                                                    Week</a></li>
                                            <li><a class="dropdown-item" href="/food-handlers-clinics/filter/30">Last
                                                    Month</a></li>
                                            <li><a class="dropdown-item" href="/food-handlers-clinics/filter/90">Last 3
                                                    month</a>
                                            </li>
