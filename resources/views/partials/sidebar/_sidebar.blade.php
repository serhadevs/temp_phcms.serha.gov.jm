<aside id="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        @if (in_array(auth()->user()->role_id, [1, 3, 4, 8, 9, 11]))
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse"
        ...
        @if (in_array(auth()->user()->role_id, [1, 4, 8, 9, 11]))
            <li class="sidebar-item">
        ...
        @if (in_array(auth()->user()->role_id, [1, 6, 8]))
            <li class="sidebar-item">
                ...
                <ul id="downloads" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item">
                        <a href="/downloads/tourist-establishments/filter/365" class="sidebar-link">Tourist
                            Establishments</a>
                    </li>
                </ul>
            </li>
