{{-- <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
    <div class="accordion-body">
        <ul class="list-group">
            <li class="list-group-item">Navigate to your Google Chrome Browser or Microsoft Edge or Firefox </li>
            <li class="list-group-item">Type the following url into the address bar: <strong>https://phcms.serha.gov.jm</strong></li>
            <li class="list-group-item">You should see the following link:</li>
            <li class="list-group-item">
                <img src="/images/training/url.PNG" alt="">
            </li>
            <li class="list-group-item">The following screen should appear:</li>
            <li class="list-group-item">
                <img src="/images/training/login.PNG" alt="" class="w-25">
            </li>
          </ul>
    </div>
  </div> --}}
    ...
    <div class="col-8">
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                <ul class="list-group">
                    <li class="list-group-item">Navigate to your Google Chrome Browser or Microsoft Edge or Firefox
                    </li>
                    <li class="list-group-item">Type the following url into the address bar:
                        <strong>https://phcms.serha.gov.jm</strong></li>
                    <li class="list-group-item">You should see the following link:</li>
                    <li class="list-group-item">
                        <img src="/images/training/url.PNG" alt="">
                    </li>
                    ...
                    <li class="list-group-item">
                        Click on the Forget your Password as seen below:
                    </li>
                    <li class="list-group-item">
                        <img src="/images/training/forgetpassword.PNG" alt="" class="w-25">
                    </li>
                    <li class="list-group-item">
                        The following screen will appear:
                    </li>
                    <li class="list-group-item">
                        <img src="/images/training/resetpasswordlogin.PNG" alt="" class="w-50">
                    </li>
                    <li class="list-group-item">
                        Enter your email address in the field shown in the image below. This will serve as your login credential for accessing the
                        system.
                    </li>
                    <li class="list-group-item">
                        <img src="/images/training/emailaddress.PNG" alt="">
                    </li>
                    <li class="list-group-item">
                        After you entered your email address, press the <em>Send Reset Passowrd Link</em> button as seen in the image below:
                    </li>
                    <li class="list-group-item">
