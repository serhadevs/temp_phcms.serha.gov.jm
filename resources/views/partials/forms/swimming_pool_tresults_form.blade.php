<div class="row mt-3">
    <div class="col">
        ...
        <input type="text" name="staff_contact" class="form-control editable-fields"
    ...
    <div class="col">
        ...
        <input type="text" name="test_location" class="form-control editable-fields"
            {{ isset($is_view) ? 'disabled' : '' }}
...
<div class="row mt-3">
    <div class="col col-md-6 col-sm-12">
        ...
        <input type="date" class="form-control editable-fields" {{ isset($is_view) ? 'disabled' : '' }}
...
<div class="row mt-3">
    <div class="col">
        ...
        <input type="number" class="form-control editable-fields" name="critical_score"
            {{ isset($is_view) ? 'disabled' : '' }}
