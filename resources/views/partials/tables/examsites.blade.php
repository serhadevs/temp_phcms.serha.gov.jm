<table class="table table-striped nowrap table-bordered" id="exam_sites" style="width:100%">
    <thead>
        <tr>
        ...
        @foreach ($exam_sites as $exam_site)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('examsites.delete',['id'=>$exam_site->id]) }}" class="btn btn-danger">Delete</a>
                </td>
