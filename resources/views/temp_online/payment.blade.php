    ...
    <div class="page page-center">
        <div class="container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    <h2 class="card-title text-center mb-4">Checkout for {{ $permit_application->firstname }}
                        {{ $permit_application->lastname }}</h2>
                    ...
                    <form onsubmit="applyCoupon(event)">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button id = "coupon_button" class="btn btn-outline-primary"
                    ...
                    <!-- Payment Form -->
                    <form method="POST" action="{{ route('permit.online.application.payment.process') }}"
                        id="formPayment">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name_on_card" id = "name_on_card" class="form-control" placeholder="Full Name">
                        </div>
                        </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    <span>1 x Food Handlers Permit Application</span>
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    <span>Subtotal:</span>
                                    <strong id="subtotal" class="text-success">$500.00</strong>
                                </div>
                                <!-- Discount -->
                                <div class="d-flex justify-content-between mb-2">
                                    <span>Discount:</span>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <strong id="total" class="text-success">$500.00</strong>
                                </div>
                            </div>
                        </div>
