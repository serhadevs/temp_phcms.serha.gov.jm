...
Route::get('/verify-permit/retrieve', [PermitApplicationApi::class, 'permitRetrieval'])->name('verify.retrieval');
...
Route::group(['middleware' => ['auth', 'prevent-back-history','check.default.password','check.password.expiry']], function () {
  ...
  Route::put('/permit/application/update/{id}', [PermitApplicationController::class, 'updateApplication'])->name('permit.application.update');
